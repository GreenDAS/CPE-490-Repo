...
*/
GenevaLCDDevice* GenevaLCDDevice_Create(GeneralPurposeTimer* Timer, int ConnectionRetries, int OnOffRatio, unsigned char MSG[2][GenevaLCDRowSize][GenevaLCDColSize]);
#endif