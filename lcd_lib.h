...
typedef struct GenevaLCDDevice{
	...
	unsigned char wholeMSG[GenevaLCDRowSize][GenevaLCDColSize + 1]; // The message to send to the LCD: First Portion or 2nd Portion of msg,the row, the col
...
*/
GenevaLCDDevice* GenevaLCDDevice_Create(GeneralPurposeTimer* Timer, int ConnectionRetries, int OnOffRatio, unsigned char MSG[GenevaLCDRowSize + 1][GenevaLCDColSize + 1]);
#endif