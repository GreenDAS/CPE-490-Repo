...
void _init_(){
	...
	Switch1.initInterupt(Switch1.pin, Switch1.GPIOchar, EXTI4_IRQn, 1); // Sets up Switch1 Interupt (PC4)
	...
	Display = GenevaLCDDevice_Create(&Timer2, 5, 10); // Sets up LCD Display
