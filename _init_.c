...
Numpad* CreateNumpad(){
	...
	rowIOP[0] = IODevice_Create('C', ROW1, 1, 0, 'I');
	rowIOP[1] = IODevice_Create('C', ROW2, 1, 0, 'I');
	rowIOP[2] = IODevice_Create('C', ROW3, 1, 0, 'I');
	rowIOP[3] = IODevice_Create('C', ROW4, 1, 0, 'I');

	colIOP[0] = IODevice_Create('C', COL1, 1, 0, 'I');
	colIOP[1] = IODevice_Create('C', COL2, 1, 0, 'I');
	colIOP[2] = IODevice_Create('C', COL3, 1, 0, 'I');
