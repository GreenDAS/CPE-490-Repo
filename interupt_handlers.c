...
void SysTick_Handler(void){ 
	...
	typedef enum {START, UPPER, LOWER, SUCCESS}dispStates;
	static dispStates dispState = START;
	static dispStates previousDispState = SUCCESS;
